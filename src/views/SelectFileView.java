...
public class SelectFileView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Selecione um arquivo");
...
if(file != null){
        try {
           int lineCount = reader.readFile(file.getPath());
            JOptionPane.showMessageDialog(null, "O arquivo: " + file.getName() + "\n" + lineCount + " linhas");
        } catch (Exception ex) {
            Logger.getLogger(SelectFileView.class.getName()).log(Level.SEVERE, null, ex);
        }
}else{
